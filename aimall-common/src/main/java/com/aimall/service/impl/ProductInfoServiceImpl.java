...
import com.aimall.utils.CollectionComparator;
...
public class ProductInfoServiceImpl implements ProductInfoService {
    ...
    public void saveProduct(ProductSaveDTO productSaveDTO) {
        ...
        if (isAdd) {
            ...
            //鑾峰彇propertyValue涓紝鏂板锛屼慨鏀癸紝鍒犻櫎鐨?
           ...
           //鍙傛暟閲屾湁锛屾暟鎹簱閲屾病鏈夌殑 涓烘柊澧烇紝涓や釜閮芥湁涓轰慨鏀?
